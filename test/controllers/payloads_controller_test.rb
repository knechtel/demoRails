...
class PayloadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payload" do
    assert_difference('Payload.count') do
      post payloads_url, params: { payload: { content: @payload.content, title: @payload.title } }
    end
  ...
  test "should update payload" do
    patch payload_url(@payload), params: { payload: { content: @payload.content, title: @payload.title } }
